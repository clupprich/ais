defmodule ChecksumTest do
  ...
  test_with_params "handle invalid checksums",
    ...
    [
      ...
      {"!AIVDM,1,1,,A,13IVvu0P0000n1>LCkW2D?v@0<1D,0*0C", :ok},
      {"!AIVDM,1,1,,A,33iVm6500000kCrLCu7ccQ:>0000,0*05", :ok},
      {"!AIVDM,1,1,,A,33ku8dU00000a:>LCD:K18m00000,0*0A", :ok},
      {"!AIVDM,1,1,,A,13IMm1301fP02m@LC56bf`P:0PSm,0*0B", :ok},
      {"!AIVDM,1,1,,A,E>jCfrv2`0c2h0W:0a2ah@@@@@@004WD>;2<H50hppN000,4*09", :ok},
      {"!AIVDM,1,1,,A,19NSG;@00swwGrPLFBq3ek8H00S;,0*05", :ok},
      {"!AIVDM,1,1,,A,13Ht`rPP0000Q9VLD:P@0?vR00Sc,0*0D", :ok},
      {"!AIVDM,1,1,,B,33IQ?i;00500k5:LCocRiH<f02vQ,0*0E", :ok},
